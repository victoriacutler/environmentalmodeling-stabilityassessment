...
*We defined our stability metric that if both the predator and prey population at time 500 is 75% or more than the initial population, our system is defined as stable*
...
stability <- stability_measure(res)
...
print("If we assume that predator and prey populations are at a value of 1 (and rprey=0.95, alpha=0.01, eff=0.6,pmort=0.4, K=2000), in order to maintain a stable population for predator and prey,we recommend allowing 75% of prey to be hunted each year.")
```
